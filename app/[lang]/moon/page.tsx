...
export default async function MoonPage({
  ...
  return (
    <div className="bg-[#020208] text-zinc-300 font-sans scroll-smooth">
      ...
      {/* Section 4: New Chemistry — Technology Moat */}
      <ScrollReveal>
      ...
      {/* Section 5: Desert Testbed */}
      <ScrollReveal>
        <section className="relative py-32 md:py-48 px-8 md:px-12 border-t border-zinc-900">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_80%,rgba(212,168,83,0.04),transparent_60%)] pointer-events-none" />
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-400 leading-relaxed text-lg max-w-2xl mx-auto whitespace-pre-line">
                {t.desert_body}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  title: t.desert_poc_title,
                  desc: t.desert_poc_body,
                  stat: "~$0.6M",
                },
                {
                  title: t.desert_pilot_title,
                  desc: t.desert_pilot_body,
                  stat: "~$18M",
                },
                {
                  title: t.desert_full_title,
                  desc: t.desert_full_body,
                  stat: "~$120M",
                },
              ].map((phase) => (
                <div
                  ...
                  className="border border-zinc-800 bg-zinc-900/30 p-6 group hover:border-amber-400/20 transition-all duration-500"
                >
                  <div className="text-2xl font-mono text-amber-400/60 mb-3 group-hover:text-amber-300 transition-colors">
                    {phase.stat}
                  </div>
                  <h4 className="text-sm font-bold uppercase tracking-wider text-zinc-200 mb-2">
                    {phase.title}
                  </h4>
                  <p className="text-xs text-zinc-500 leading-relaxed">
                    {phase.desc}
      ...
      {/* Section 6: Type I Civilization */}
      <ScrollReveal>
        <section className="relative py-32 md:py-48 px-8 md:px-12 border-t border-zinc-900 overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_50%,rgba(255,200,100,0.03),transparent_60%)] pointer-events-none" />
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-amber-400/50">
              § 06
            </span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="space-y-16">
                {[
                  { phase: t.timeline_phase_0, desc: t.timeline_phase_0_desc },
                  ...
                  { phase: t.timeline_phase_5, desc: t.timeline_phase_5_desc },
                ].map((item, i) => (
                  <div
                    key={item.phase}
